<template>
  <footer
    class="mt-[50px] text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left mx-[50px]"
  >
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        <div class="">
          <h6
            class="mb-4 flex items-center justify-center font-semibold md:justify-start text-[18px]"
          >
            <a href="#">
              <img
                class="inline-block"
